...
const BlogPost: React.FC<BlogPostProps> = ({ post }) => {
  ...
  return (
    <div className="bg-green-50 dark:bg-slate-900 dark:border dark:border-slate-800 rounded-2xl shadow-sm overflow-hidden flex flex-col transition-colors duration-300">
      ...
      <div className="p-4 sm:p-6 text-center text-dark dark:text-gray-200 flex-grow flex flex-col items-center">
